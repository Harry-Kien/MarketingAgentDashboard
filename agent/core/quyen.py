...
DANH_SACH_HOAN: frozenset[tuple[str, str]] = frozenset({
    ...
    ("GET", "/api/cai-dat-api"),
    ("POST", "/api/cai-dat-api/kiem-tra"),
    ("DELETE", "/api/cai-dat-api/{khoa}"),
    ("PUT", "/api/cai-dat-api/{khoa}"),
    ("POST", "/api/campaigns"),
    ...
    ("DELETE", "/api/channel-accounts/{account_id}"),
    ("GET", "/api/channel-accounts/{account_id}"),
    ("GET", "/api/channel-accounts/{account_id}/co-xoa-duoc"),
    ("PUT", "/api/channel-accounts/{account_id}/credentials"),
    ("POST", "/api/channel-accounts/{account_id}/dang-ky-webhook"),
    ...
    ("POST", "/api/channel-accounts/{account_id}/verify"),
    ("GET", "/api/channel-accounts/{account_id}/verify-token"),
    ("POST", "/api/channel-accounts/{account_id}/zalo-personal/qr"),
    ("POST", "/api/channel-accounts/{account_id}/zalo-personal/restore"),
    ("GET", "/api/channel-accounts/{account_id}/zalo-personal/status"),
    ("GET", "/api/channels"),
    ("POST", "/api/connect/meta/chon"),
    ...
    ("POST", "/api/data-retention/jobs/{job_id}/approve"),
    ("POST", "/api/data-retention/jobs/{job_id}/cancel"),
    ("POST", "/api/data-retention/jobs/{job_id}/execute-dry-run"),
    ("POST", "/api/erp/kiem-ket-noi"),
    ("GET", "/api/erp/san-pham"),
    ("GET", "/api/erp/san-pham/{ma}"),
    ("GET", "/api/erp/suc-khoe"),
    ("GET", "/api/erp/ton-kho/{ma}"),
    ("DELETE", "/api/erp/xac-nhan-bang-gia"),
    ("GET", "/api/erp/xac-nhan-bang-gia"),
    ("POST", "/api/erp/xac-nhan-bang-gia"),
    ("GET", "/api/events"),
    ("GET", "/api/goi-ky-nang"),
    ("POST", "/api/goi-ky-nang"),
    ("POST", "/api/goi-ky-nang/kiem"),
    ("POST", "/api/goi-ky-nang/tep"),
    ("DELETE", "/api/goi-ky-nang/{ten}"),
    ("POST", "/api/goi-ky-nang/{ten}/bat-tat"),
    ("POST", "/api/goi-ky-nang/{ten}/khoi-phuc/{id_lich_su}"),
    ("GET", "/api/goi-ky-nang/{ten}/lich-su"),
    ("GET", "/api/goi-ky-nang/{ten}/xuat"),
    ...
    ("POST", "/api/mcp/kiem"),
    ("DELETE", "/api/mcp/{ten}"),
    ("POST", "/api/mcp/{ten}/bat-tat"),
    ("POST", "/api/mcp/{ten}/cong-cu/{ten_cong_cu}"),
    ("POST", "/api/mcp/{ten}/dong-bo"),
    ...
    ("GET", "/api/outbox/jobs"),
    ("POST", "/api/outbox/jobs/{job_id}/cancel"),
    ("POST", "/api/outbox/jobs/{job_id}/retry"),
    ("GET", "/api/overview"),
    ("GET", "/api/pdpd"),
    ("POST", "/api/pdpd/don-theo-han"),
    ("GET", "/api/pdpd/{sdt}"),
    ("POST", "/api/pdpd/{sdt}/xoa"),
    ("GET", "/api/phong-thu/goi-y"),
    ("GET", "/api/phong-thu/ngan-sach"),
    ("POST", "/api/phong-thu/phien"),
    ("DELETE", "/api/phong-thu/phien/{pid}"),
    ("GET", "/api/phong-thu/phien/{pid}"),
    ("POST", "/api/phong-thu/phien/{pid}/hoi"),
    ("GET", "/api/posts"),
    ("POST", "/api/posts"),
